...
public class UserManager {
  public void Add (User user) {
	...
	public void upload(User user) {
			System.out.println(user.getFirstName() + " " + user.getLastName() + " adlý " + user.getUserType() + " Yorumunu güncelledi.");
	...
	public void removeComment(User user) {
			System.out.println(user.getFirstName() + " " + user.getLastName() + " adlý " + user.getUserType() + " Yorumunu kaldýrdý.");
